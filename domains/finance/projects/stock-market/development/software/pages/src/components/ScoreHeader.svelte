...
<style>
  ...
  .ticker-section { display: flex; align-items: center; gap: 0.75rem; }
  .ticker-label { font-size: 1.1rem; font-weight: 700; }
  .dir-badge { font-size: 1.2rem; font-weight: 800; }
  .confidence { font-size: 0.82rem; color: var(--muted); }
  .meta { display: flex; gap: 1rem; flex: 1; }

...
<tr class:neutral class:expanded>
  <td class="name-cell">
    <button class="expand-btn" on:click={clickToggle} title="Show definitions">
  ...
  <td class="research-cell">
    <button class="research-btn" on:click={clickResearch} title="Research {param.label}">🔬</button>
  </td>
</tr>
...
<style>
  ...
  .name-cell { min-width: 180px; display: flex !important; align-items: center; gap: 0.4rem; }
  .expand-btn {
  ...
  .param-name  { font-family: monospace; font-size: 0.78rem; color: var(--text); }
  .param-label { font-size: 0.67rem; color: var(--muted); }
